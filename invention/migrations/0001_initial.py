# Generated by Django 4.2.8 on 2024-01-06 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2024, 1, 6, 14, 4, 43, 674597))),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='invention.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=0)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2024, 1, 6, 14, 4, 43, 675725))),
                ('status', models.CharField(choices=[('checked_in', 'checked_in'), ('checked_out', 'checked_out')], max_length=20)),
